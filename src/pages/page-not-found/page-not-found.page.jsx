...
const PageNotFound = () => {
    useEffect(() => {
        ...
        return () => {
            animation1.pause(); // Pause or stop the animation as needed
            animation2.pause();
        };
    }, []);
    ...
    return (
        <div className="page-not-found">
            ...
            <div className="container">
                ...
                <h1 className="page-not-found__title">La page est introuvable</h1>
                <h2 className="page-not-found__title2" >
                    <Link to="/">Retourner à l'acceuil</Link></h2>
            </div >
        </div >
    )
}
